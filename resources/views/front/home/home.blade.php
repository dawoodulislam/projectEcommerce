                ...
                <div class="box2">
                    <ul class="list1">
                        ...
                        <li class="list1_right">
                            <p>Upto 5% Reward on your shipping</p>
                        </li>
            ...
            <div class="col-md-3">
                <div class="box5">
                    <ul class="list1">
                        <i class="dollar"> </i>
                        <li class="list1_right">
                            <p>Delivery Schedule Spread Cheer Time</p>
                        </li>
                        <div class="clearfix"> </div>
                    </ul>
                </div>
                ...
                <div class="box_inner">
                    ...
                    <div class="desc">
                        ...
                        <ul class="list2">
                            ...
                            <li class="list2_right"><span class="m_2"><a href="{{ route('productDetail', ['id' => $product->id]) }}" class="link1">See More</a></span></li>
                            <div class="clearfix"> </div>
                        </ul>
                        <div class="heart"> </div>
                    </div>
...
<div class="content_middle">
    <div class="container">
        ...
        <ul id="flexiselDemo3">
            <li><img src="{{ asset('/') }}front/images/n1.jpg" class="img-responsive" />
                <div class="grid-flex">
            ...
            <li><img src="{{ asset('/') }}front/images/n2.jpg" class="img-responsive" />
                <div class="grid-flex">
                    <h4>Contrary to popular </h4>
                    <p>589,90 $</p>
                    <div class="m_3"><a href="#" class="link2">Add to Cart</a></div>
            ...
            <li><img src="{{ asset('/') }}front/images/n3.jpg" class="img-responsive" />
                <div class="grid-flex">
                    <h4>Contrary to popular </h4>
                    <p>589,90 $</p>
                    <div class="m_3"><a href="#" class="link2">Add to Cart</a></div>
            ...
            <li><img src="{{ asset('/') }}front/images/n4.jpg" class="img-responsive" />
                <div class="grid-flex">
                    <h4>Contrary to popular </h4>
                    <p>589,90 $</p>
                    <div class="m_3"><a href="#" class="link2">Add to Cart</a></div>
            ...
            <li><img src="{{ asset('/') }}front/images/n5.jpg" class="img-responsive" />
                <div class="grid-flex">
                    <h4>Contrary to popular </h4>
                    <p>589,90 $</p>
                    <div class="m_3"><a href="#" class="link2">Add to Cart</a></div>
