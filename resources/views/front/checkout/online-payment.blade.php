                ...
                <div class="panel">
                    ...
                    <div class="panel-body" style="border: 1px solid lightgray">
                        <form action="https://sandbox.aamarpay.com/index.php" method="POST">
                                ...
                                <input type="hidden" name="cus_phone" value="{{ $customer->number }}"/>
                                ...
                                <input type="hidden" name="success_url" value="http://localhost/projectEcommerce/public/confirm-online-payment"/>
